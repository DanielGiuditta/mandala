...
set supervisor_person_id = case id
  when '10000000-0000-0000-0000-000000000004'::uuid then '10000000-0000-0000-0000-000000000001'::uuid
  when '10000000-0000-0000-0000-000000000005'::uuid then '10000000-0000-0000-0000-000000000002'::uuid
  when '10000000-0000-0000-0000-000000000006'::uuid then '10000000-0000-0000-0000-000000000003'::uuid
  else null::uuid
end
where id in (
  '10000000-0000-0000-0000-000000000001',
...
set partner_person_id = case id
  when '00000000-0000-0000-0000-000000000001'::uuid then '10000000-0000-0000-0000-000000000001'::uuid
  when '00000000-0000-0000-0000-000000000002'::uuid then '10000000-0000-0000-0000-000000000002'::uuid
  when '00000000-0000-0000-0000-000000000003'::uuid then '10000000-0000-0000-0000-000000000003'::uuid
